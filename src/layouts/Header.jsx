      ...
      <Container>
        <div className='relative mb-14 mt-4 md:m-0'>
          <div className='absolute flex flex-col gap-4 md:gap-6 top-12 sm:top-16 lg:top-20'>
            <a href='https://github.com/Rasyid1609/' target='_blank' rel='noopener noreferrer' className='w-7 h-7'>
              <FiGithub className='w-7 h-7' />
            </a>
            <a href='https://www.facebook.com/faishal.rasyiq/' target='_blank' rel='noopener noreferrer'>
              <FiFacebook className='w-7 h-7' />
            </a>
            <a href='https://www.linkedin.com/in/faishal-ammar-rasyiq/' target='_blank' rel='noopener noreferrer'>
          ...
          <div className='flex justify-between gap-6 items-center md:ml-20 lg:ml-36 flex-col md:flex-row-reverse'>
            <img src='/myprofile.jpg' className='profile-animation w-52 bg-black/5 p-1 sm:w-64 lg:w-72 ml-12 md:ml-0' />
            <div className='self-stretch md:self-center flex justify-center'>
              <div>
                ...
                <div className='flex gap-2 flex-wrap py-2'>
                  <button>
                    <a
                      href='/cv-faishal-ammar-rasyiq.pdf'
                      download={true}
